const SpecialCare = {
  value: `Sparky does need some special care with his handling. In general he tends to be the best with his trusted alpha but will be more reserved with others, even other loved ones. In general Sparky does not like being patted or touched but will tolerate pretty much anything from his trusted alpha and in small doses from other loved ones. (This doesn’t stop him from wanting to be with you or on a lap though!) 
